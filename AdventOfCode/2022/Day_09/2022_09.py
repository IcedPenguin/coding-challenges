...
###################################################################################################################################################################
#  
#  Solution to part 1: 6018
#
#  Solution to part 2: 2619
#
###################################################################################################################################################################
...
#   on a two-dimensional grid. Then, by following a hypothetical series of motions (your puzzle input) for the 
...
class Knot:
    ...
    def follow(self, other_knot):
        x_diff = self.x - other_knot.x
        y_diff = self.y - other_knot.y
...
def process_knot_movement(moves):
    head_knot = Knot(0,0)
    tail_knot = Knot(0,0)

    locations_tail_visited = set()
    ...
    for move in moves:
        ...
        for i in range(amount):
            ...
            tail_knot.follow(head_knot)

            locations_tail_visited.add(tail_knot.get_knot_location())

    return locations_tail_visited



class Day9PartOneTests(unittest.TestCase):

    def test__p1__move(self):
        knot = Knot(0,0)
        self.assertEqual(knot.get_knot_location(), (0, 0))

        knot.move("U")
        self.assertEqual(knot.get_knot_location(), (0, 1))

        knot.move("L")
        self.assertEqual(knot.get_knot_location(), (-1, 1))

        knot.move("D")
        self.assertEqual(knot.get_knot_location(), (-1, 0))
        ...
        knot.move("UR")
        self.assertEqual(knot.get_knot_location(), (0, 2))
    ...
    def test__p1__follow(self):
        knot = Knot(0,0)
        other_knot = Knot(0, 5)

        # we can go in a straight line
        knot.follow(other_knot)
        self.assertEqual(knot.get_knot_location(), (0, 1))
        knot.follow(other_knot)
        self.assertEqual(knot.get_knot_location(), (0, 2))

        # we stop moving once we are sufficently close
        other_knot = Knot(2,2)
        knot.follow(other_knot)
        self.assertEqual(knot.get_knot_location(), (1, 2))
        knot.follow(other_knot)
        self.assertEqual(knot.get_knot_location(), (1, 2))

        # we can follow diagnals
        knot = Knot(0,0)
        other_knot = Knot(4,4)
        knot.follow(other_knot)
        self.assertEqual(knot.get_knot_location(), (1, 1))
        knot.follow(other_knot)
        self.assertEqual(knot.get_knot_location(), (2, 2))



    def test__p1__sample2(self):
        raw_moves = load_file(sample_input_file_1)
        moves = raw_moves.split("\n")
        locations_tail_visited = process_knot_movement(moves)
        self.assertEqual(len(locations_tail_visited), 13)
        

    
    def test__part_1__challenge_input(self):
        print("")
        raw_moves = load_file(input_file)
        moves = raw_moves.split("\n")
        locations_tail_visited = process_knot_movement(moves)
        print("Solution to day {0} part 1: {1}".format(puzzle_day, len(locations_tail_visited)))
...
def process_knot_movement_advanced(moves, knot_count):
    knots = []
    ...
    for move in moves:
        ...
        for i in range(amount):
            for j in range(knot_count):
                ...
                # tail of the rope, track location
                if j == knot_count -1: 
                    locations_tail_visited.add(knots[j].get_knot_location())
...
class Day9PartTwoTests(unittest.TestCase):
    ...
    def test__p2__sample1_knots_2(self):
        raw_moves = load_file(sample_input_file_1)
        moves = raw_moves.split("\n")
        locations_tail_visited = process_knot_movement_advanced(moves, 2)
        self.assertEqual(len(locations_tail_visited), 13)

    def test__p2__sample1_knots_10(self):
        raw_moves = load_file(sample_input_file_1)
        moves = raw_moves.split("\n")
        locations_tail_visited = process_knot_movement_advanced(moves, 10)
        self.assertEqual(len(locations_tail_visited), 1)
    ...
    def test__part_2__challenge_input(self):
        ...
        moves = raw_moves.split("\n")
        locations_tail_visited = process_knot_movement_advanced(moves, 10)
        print("Solution to day {0} part 2: {1}".format(puzzle_day, len(locations_tail_visited)))
